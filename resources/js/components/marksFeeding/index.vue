...
<script>
  ...
  export default {
    ...
    methods: {
      subjectList() {
        this.$http.get('https://emerald-field-schools.ishlp.com/api/subjectlist').then(response => {
          this.subjects = response.data.data;
        })
      },
      subjectStudents: function(subjectid) {
        if (typeof subjectid === 'number') {
          this.$http.get('https://emerald-field-schools.ishlp.com/api/subjectstudents/subject/' + subjectid).then(response => {
      ...
      submitFormData: function() {
        ...
        this.$http
          .post('https://emerald-field-schools.ishlp.com//api/subjectresult', this.marks)
          .then(data => {
            this.succmsg = false
            this.seen = false
            console.log(data)
