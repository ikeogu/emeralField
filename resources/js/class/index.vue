              ...
              <tbody v-if="this.laravelData.data.length > 0">
                <tr v-for="las in laravelData.data" :key="las.id">
                  ...
                  <td><a href="#"
                       ...
                       data-toggle="modal"
                       v-bind:title="las.name" class="btn btn-warning text-white rounded-circle mr-3">Edit</a></td>
                  <td><a href="#" data-target="#exampleModal2" v-on:click="deleteId(las.id)" data-toggle="modal" v-bind:id="id" class="btn btn-danger text-white rounded-circle mr-3">Delete</a></td>
                </tr>
